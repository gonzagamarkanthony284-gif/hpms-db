...
public class PatientEditTypeTest {
    public static void main(String[] args) throws Exception {
        List<String> out = PatientService.add("EditTypeTest","35","Female","777-7777","Addr");
        System.out.println(out);
        String id = out.get(0).split(" ")[2];
        // edit to set registration type
        List<String> res = PatientService.editExtended(id, "EditTypeTest", "35", "Female", "777-7777", "Addr",
        ...
        if (!"Emergency Patient".equals(p.registrationType)) { System.err.println("Edit failed"); System.exit(2); }
