...
public class GuiSmokeTest {
    public static void main(String[] args) {
        ...
        Patient p = new Patient("PTEST", "Smoke Tester", 33, Gender.Male, "555-0101", "123 Test St", LocalDateTime.now());
        ...
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                if (DataStore.patients.containsKey("PTEST")) System.out.println("Smoke test success: patient present in DataStore");
                else System.err.println("Smoke test failure: patient missing from DataStore");
            } catch (Throwable t) {
                t.printStackTrace();
                System.exit(1);
            }
