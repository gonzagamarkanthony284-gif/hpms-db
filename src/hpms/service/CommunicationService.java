...
public class CommunicationService {
    ...
    public static List<String> addNote(String patientId, String staffId, String text){ 
        ...
        DataStore.staffNotes.computeIfAbsent(patientId, k->new ArrayList<>()).add(new StaffNote(staffId, text==null?"":text.trim(), LocalDateTime.now())); 
    ...
    public static List<String> addAlert(String patientId, String text){ 
        ...
        DataStore.criticalAlerts.computeIfAbsent(patientId, k->new ArrayList<>()).add(text==null?"":text.trim()); 
    ...
    public static List<String> sendMessage(String senderId, String recipientId, String subject, String messageContent, String messageType) {
        List<String> out = new ArrayList<>();
        
        if (Validators.empty(senderId) || Validators.empty(recipientId) || Validators.empty(subject) || Validators.empty(messageContent)) {
    ...
    public static List<String> getInbox(String userId) {
        ...
        if (out.isEmpty()) out.add("No messages");
        return out;
    }
